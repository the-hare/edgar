...
var edgar = {render_stock_graph:function(a, b, c, d) {
  ...
  return cljs.core.ObjMap.fromObject("\ufdd0'local-list \ufdd0'macd-price-list \ufdd0'stock-name \ufdd0'sma-list \ufdd0'macd-histogram-list \ufdd0'ema-list \ufdd0'stochastic-d \ufdd0'bollinger-band \ufdd0'obv \ufdd0'stochastic-k \ufdd0'macd-signal-list".split(" "), {"\ufdd0'local-list":cljs.core.into_array.call(null, cljs.core.reduce.call(null, function(a, c) {
...
edgar.populate_multiselect.call(null, ".multiselect-historical", cljs.core.ObjMap.fromObject(["\ufdd0'onChange"], {"\ufdd0'onChange":function(a, b) {
  return cljs.core.truth_(b) ? $.ajax.call(null, "/get-historical-data", cljs.core.clj__GT_js.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'data", "\ufdd0'complete"], {"\ufdd0'data":cljs.core.ObjMap.fromObject(["\ufdd0'stock-selection", "\ufdd0'time-duration", "\ufdd0'time-interval"], {"\ufdd0'stock-selection":a.val(), "\ufdd0'time-duration":"300 S", "\ufdd0'time-interval":"1 secs"}), "\ufdd0'complete":function(a, b) {
    ...
    console.log([cljs.core.str("obv["), cljs.core.str((new cljs.core.Keyword("\ufdd0'obv")).call(null, f)), cljs.core.str("]")].join(""));
    console.log([cljs.core.str("obv INPUT["), cljs.core.str((new cljs.core.Keyword("\ufdd0'obv")).call(null, (new cljs.core.Keyword("\ufdd0'signals")).call(null, e))), cljs.core.str("]")].join(""));
    return edgar.render_stock_graph.call(null, "#historical-stock-graph", cljs.core.PersistentVector.fromArray([(new cljs.core.Keyword("\ufdd0'local-list")).call(null, f), (new cljs.core.Keyword("\ufdd0'sma-list")).call(null, f), (new cljs.core.Keyword("\ufdd0'ema-list")).call(null, f), (new cljs.core.Keyword("\ufdd0'bollinger-band")).call(null, f), (new cljs.core.Keyword("\ufdd0'macd-price-list")).call(null, f), (new cljs.core.Keyword("\ufdd0'macd-signal-list")).call(null, f), (new cljs.core.Keyword("\ufdd0'macd-histogram-list")).call(null, 
    f), (new cljs.core.Keyword("\ufdd0'stochastic-k")).call(null, f), (new cljs.core.Keyword("\ufdd0'stochastic-d")).call(null, f), (new cljs.core.Keyword("\ufdd0'obv")).call(null, f)], !0), (new cljs.core.Keyword("\ufdd0'stock-name")).call(null, f), !1)
  }}))) : null
}}));
