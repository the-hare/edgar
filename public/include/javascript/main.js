...
var edgar = {add_signals:function(a, b) {
...
}, build_graph_series_data:function(a) {
  ...
  "\ufdd0'radius"], {"\ufdd0'enabled":!0, "\ufdd0'radius":3}), "\ufdd0'shadow":!0, "\ufdd0'tooltip":cljs.core.ObjMap.fromObject(["\ufdd0'valueDecimals"], {"\ufdd0'valueDecimals":2})}), cljs.core.ObjMap.fromObject("\ufdd0'type \ufdd0'name \ufdd0'data \ufdd0'color \ufdd0'fillColor \ufdd0'width \ufdd0'style \ufdd0'states".split(" "), {"\ufdd0'type":"flags", "\ufdd0'name":"strategies", "\ufdd0'data":cljs.core.PersistentVector.EMPTY, "\ufdd0'color":"#5F86B3", "\ufdd0'fillColor":"#5F86B3", "\ufdd0'width":16, 
  "\ufdd0'style":cljs.core.ObjMap.fromObject(["\ufdd0'color"], {"\ufdd0'color":"white"}), "\ufdd0'states":cljs.core.ObjMap.fromObject(["\ufdd0'hover"], {"\ufdd0'hover":cljs.core.ObjMap.fromObject(["\ufdd0'fillColor"], {"\ufdd0'fillColor":"#395C84"})})})], !0)
  ...
  return cljs.core.reduce.call(null, function(b, c) {
    var d = function(a) {
      return cljs.core.ObjMap.fromObject(["\ufdd0'x", "\ufdd0'title", "\ufdd0'text"], {"\ufdd0'x":(new cljs.core.Keyword("\ufdd0'x")).call(null, a), "\ufdd0'title":(new cljs.core.Keyword("\ufdd0'title")).call(null, a), "\ufdd0'text":(new cljs.core.Keyword("\ufdd0'text")).call(null, a)})
    };
    return cljs.core.concat.call(null, b, cljs.core.reduce.call(null, function(b, c) {
      console.log([cljs.core.str("... AND > eF["), cljs.core.str(c), cljs.core.str("]")].join(""));
      var e = d.call(null, c);
      console.log([cljs.core.str("... AND AND > strategy-entry["), cljs.core.str(e), cljs.core.str("] > fn["), cljs.core.str("]")].join(""));
      cljs.core.nth.call(null, jayq.core.$.call(null, a).highcharts().series, 10).addPoint(e, !0);
      return cljs.core.conj.call(null, b, e)
    }, cljs.core.PersistentVector.EMPTY, cljs.core.second.call(null, c)))
  }, cljs.core.PersistentVector.EMPTY, cljs.core.seq.call(null, d))
  ...
  }, cljs.core.PersistentVector.EMPTY, cljs.core.remove.call(null, cljs.core.nil_QMARK_, (new cljs.core.Keyword("\ufdd0'macd")).call(null, (new cljs.core.Keyword("\ufdd0'signals")).call(null, a))))), "\ufdd0'signals":cljs.core.ObjMap.fromObject(["\ufdd0'moving-average", "\ufdd0'bollinger-band", "\ufdd0'macd", "\ufdd0'stochastic-oscillator", "\ufdd0'obv"], {"\ufdd0'moving-average":edgar.pull_out_signals.call(null, a, "\ufdd0'moving-average"), "\ufdd0'bollinger-band":edgar.pull_out_signals.call(null, 
  a, "\ufdd0'bollinger-band"), "\ufdd0'macd":edgar.pull_out_signals.call(null, a, "\ufdd0'macd"), "\ufdd0'stochastic-oscillator":edgar.pull_out_signals.call(null, a, "\ufdd0'stochastic-oscillator"), "\ufdd0'obv":edgar.pull_out_signals.call(null, a, "\ufdd0'obv")})})
}};
