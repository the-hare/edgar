...
edgar.populate_multiselect = (function populate_multiselect(){
var G__26738 = (new cljs.core.Keyword("\uFDD0'bind")).call(null,jayq.core.deferred_m);
var G__26739 = (new cljs.core.Keyword("\uFDD0'return")).call(null,jayq.core.deferred_m);
var G__26740 = (new cljs.core.Keyword("\uFDD0'zero")).call(null,jayq.core.deferred_m);
return G__26738.call(null,$.ajax.call(null,"/list-filtered-input"),(function (filtered_input){
return G__26739.call(null,(function (){var multiselect = jayq.core.$.call(null,".multiselect");
...
return jayq.core.$.call(null,".multiselect").multiselect(cljs.core.clj__GT_js.call(null,cljs.core.ObjMap.fromObject(["\uFDD0'enableFiltering","\uFDD0'onChange"],{"\uFDD0'enableFiltering":true,"\uFDD0'onChange":(function (element,checked){
console.log([cljs.core.str("element["),cljs.core.str(element),cljs.core.str("] / checked["),cljs.core.str(checked),cljs.core.str("]")].join(''));
return $.ajax.call(null,"/get-historical-data",cljs.core.clj__GT_js.call(null,cljs.core.ObjMap.fromObject(["\uFDD0'complete"],{"\uFDD0'complete":(function (jqXHR,status){
return null;
})})));
})})));
})());
